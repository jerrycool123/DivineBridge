    ...
    <div className={`my-5 container text-white ${styles.documentRoot}`}>
      <div>
        ...
        <p>
          ...
          <Link className="link" href="https://divine-bridge.jerrycool123.com/">
        ...
        <p>
          Divine Bridge is a Discord bot verifying YouTube channel memberships &amp; linking them
          with Discord server roles.
        </p>
        <p>You can contact us by email at jerrycool71534@gmail.com.</p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity (&quot;<strong>you</strong>&quot;), and Divine
          Bridge, concerning your access to and use of the Services. You agree that by accessing the
        ...
        <p>
          ...
          jerrycool71534@gmail.com. If we ever grant you the permission to post, reproduce, or
        ...
        <p>
          ...
          you reside, or if a minor, you have received parental permission to use the Services; (6)
          you will not access the Services through automated or non-human means, whether through a
          bot, script or otherwise; (7) you will not use the Services for any illegal or
        ...
        <p>Divine Bridge is free to use.</p>
        <h2>6. CANCELLATION</h2>
        <p>You can revoke your authorization on Divine Bridge&apos;s dashboard at any time.</p>
        <p>
          If you are unsatisfied with our Services, please email us at jerrycool71534@gmail.com.
        </p>
        ...
        <p>
          ...
          no longer be available on and through the Services. You will have the ability to disable
          the connection between your account on the Services and your Third-Party Accounts at any
          time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED
          WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH
          THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social Network Content for
          ...
          Services. You can deactivate the connection between the Services and your Third-Party
        ...
        <p>
          ...
          leave the Services and access the Third-Party Websites or to use or install any
          Third-Party Content, you do so at your own risk, and you should be aware these Legal Terms
          no longer govern. You should review the applicable terms and policies, including privacy
          and data gathering practices, of any website to which you navigate from the Services or
        ...
        <p>
          ...
          <Link className="link" href="https://divine-bridge.jerrycool123.com/privacy">
            https://divine-bridge.jerrycool123.com/privacy
          </Link>
          . By using the Services, you agree to be bound by our Privacy Policy, which is
          incorporated into these Legal Terms. Please be advised the Services are hosted in Taiwan.
          ...
          applicable laws in Taiwan, then through your continued use of the Services, you are
          transferring your data to Taiwan, and you expressly consent to have your data transferred
          to and processed in Taiwan. Further, we do not knowingly accept, request, or solicit
        ...
        <p>
          These Legal Terms shall be governed by and defined following the laws of Taiwan. Divine
          Bridge and yourself irrevocably consent that the courts of Taiwan shall have exclusive
          jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
        </p>
        <h2>17. DISPUTE RESOLUTION</h2>
        <p>
          You agree to irrevocably submit all disputes related to these Legal Terms or the legal
          relationship established by these Legal Terms to the jurisdiction of the Taiwan courts.
          Divine Bridge shall also maintain the right to bring proceedings as to the substance of
          the matter in the courts of the country where you reside or, if these Legal Terms are
          entered into in the course of your trade or profession, the state of your principal place
          of business.
        </p>
